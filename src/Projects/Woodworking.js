	...
	return (
		<div>
			...
			<div className="w-100 container-fluid">
				<FullRowText>
				During high school, I started learning how to build things out of wood,
				thanks to a Technical Theatre elective. In this class, we built the sets
				for the school plays, and I enjoyed it so much that I retook it 5
				times just to could keep building - I loved the hands on nature of it.
				I was lucky to have an incredible teacher, Mr. Travis Stevens, who guided
				...
				fellow at Breakthrough New Orleans, a summer educational program and camp
				...
				<FullRowText>
				I took a Genetics course in which the final project was to research a genetic
				disorder and make some sort of presentation for it. The disorder I picked was
				Jeune Asphyxiating Thoracic Dystrophy, which impairs bone growth. One place
				where it can have a severe impact is in the ribcage, reducing lung capacity.
				As a demo, I made a model of some normal sized and impaired ribcages to show
				the limited lung capacity.
				</FullRowText>
				<div className="row">
					<div className="col" >
						<img className="pt-4 mx-auto pb-4 d-block"
				...
				<div className="row">
					<div className="col-sm-5 mx-auto text-start fs-5 d-flex align-items-center pt-4">
						<p>
						During my senior year, one of my friends was making a room in his house
						into sort of a poker room. We built this door/bookshelf for him that had
						hinges and served as a sort of hidden door that looked like a bookshelf.
						This was a great time and a fun thing to make with friends!
						</p>
					</div>
					<div className="col" >
						<img className="pt-4 mx-auto pb-4 d-block"
