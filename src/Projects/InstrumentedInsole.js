		...
		<div>
			...
			<div className="w-100 container-fluid">
				...
				<div className="row">
					<div className="col text-start fs-5 d-flex align-items-center pt-4">
						<p>
						The prior insoles had a small protoboard in them to act like a bus for the ground and power connections of the sensors. This made parts of them stiff and prone to breaking. We started by removing the protoboards and initial molds came out as shown above, with some defects in the upper area of the foot. Additionally, the wiring was a bit messy. We had to make molds for various sizes, which my partner designed and we made out of HDPE on a CNC Router.
						</p>
					</div>
					<div className="col-sm-3" >
						<img className="pt-4 mx-auto pb-4 d-block" src='project-assets/Instrumented Insole/Initial Molds.png' style={firstPicStyle}/>
					</div>
					<div className="col-sm-4" >
						<img className="pt-4 mx-auto pb-4 d-block" src='project-assets/Instrumented Insole/Insole Molds.png' style={firstPicStyle}/>
					</div>
				</div>
				<div className="row">
					<div className="col-sm-3" >
						<img className="pt-4 mx-auto pb-4 d-block" src='project-assets/Instrumented Insole/Rewiring Idea.png' style={firstPicStyle}/>
					</div>
					<div className="col-sm-3" >
						<img className="pt-4 mx-auto pb-4 d-block" src='project-assets/Instrumented Insole/Labview VI.png' style={firstPicStyle}/>
					</div>
					<div className="col text-start fs-5 d-flex align-items-center pt-4">
						<p>
						Our next step was improving the wiring, so we daisy chained the ground and power connections for each pair of sensors. This came out less messy which we liked. Finally, we worked on testing. I wrote a LabView VI to read and export the sensor data to a file so we could analyze it in MATLAB.
						</p>
					</div>
				</div>
