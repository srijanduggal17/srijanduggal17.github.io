	...
	return (
		<div>
			...
			<div className="w-100 container-fluid">
				<FullRowText>
				Throughout my last two years of high school, I participated in and co-led the Science Olympiad team. This is actually what sparked my interest in studying engineering in college! We had fun building projects for the competition and learning about various tools and technologies.
				</FullRowText>
				<FullRowText>
				The purpose of this competition was to make a battery powered car that moved in a straight line as fast as possible, and stopped as close to the destination as possible. Our initial prototype involved using an existing RC car for the motor and axles, and then creating a circuit with an Arduino to control it with a pushbutton and a potentiometer to vary the distance before stopping. We started on a breadboard and then soldered our controls onto a protoboard.
				</FullRowText>
				<div className="row">
				...
				<div className="row">
					...
					<div className="col-md-4" >
						<img className="pt-4 mx-auto d-block" src='project-assets/Electric Vehicle/EV 2016 v2 Frame.JPG' style={secondPicStyle}/>
					</div>
				</div>
				<div className="row">
